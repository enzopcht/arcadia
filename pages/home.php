...
<div class="hero-scene">
    <div class="">
        <div class="hero-scene-content d-flex gap-5 justify-content-center align-items-center">
            <img src="/assets/images/logo_arcadia.png"  alt="Logo d'Arcadia">
...
<main>
    ...
    <div class="bg-black">
        <article class="container-xl mx-auto py-5 row align-items-center">
            ...
            <div class="col-12 text-center">
                <a href="#" class="btn btn-dark">Voir nos habitats</a>
            </div>
        </article>
    </div>
    ...
    <article class="container-xl mx-auto py-5 row align-items-center">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="col-12 text-center">
                <a href="#" class="btn btn-primary">Voir nos services</a>
            </div>
        </div>
    </article>
